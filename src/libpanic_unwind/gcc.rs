...
#[cfg(all(any(target_os = "ios", target_os = "watchos", target_os = "netbsd", not(target_arch = "arm"))))]
#[lang = "eh_personality"]
#[no_mangle]
#[allow(unused)]
...
#[cfg(all(target_arch = "arm", not(target_os = "ios"), not(target_os = "watchos"), not(target_os = "netbsd")))]
#[lang = "eh_personality"]
#[no_mangle]
